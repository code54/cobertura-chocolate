...
public class ReportConstants {
    ...
    public static final String threshold_metric_name_branch_coverage = "branch_coverage_threshold";
    public static final String threshold_metric_name_line_coverage = "line_coverage_threshold";
    public static final String threshold_metric_name_ccn = "ccn_threshold";
}
